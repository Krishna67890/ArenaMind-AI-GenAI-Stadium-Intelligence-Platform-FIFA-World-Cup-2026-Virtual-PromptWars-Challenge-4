                ...
                {view === "globe" ? (
                    ...
                    <Html center transform distanceFactor={10}>
                      <div className="flex flex-col items-center gap-12">
                        ...
                        <div className="text-center space-y-3">
                           <h2 className="text-6xl font-black italic tracking-tighter uppercase text-gradient">Explore Global Host Cities</h2>
                           <div className="flex items-center justify-center gap-4">
                             <div className="h-[1px] w-12 bg-gradient-to-r from-transparent to-blue-500/50" />
                             <p className="text-white/40 text-xs font-bold uppercase tracking-[0.5em] animate-pulse">Neural Geospatial Intelligence Grid</p>
                  ...
                  <group>
                    ...
                    <Html position={[0, 10, -15]} center transform distanceFactor={10}>
                      <div className="sketchfab-embed-wrapper w-[800px] h-[450px] bg-black/20 backdrop-blur-md rounded-3xl overflow-hidden border border-white/10 shadow-2xl">
                        <iframe
                          title="Arrowhead NFL"
        ...
        <AnimatePresence>
          {showHUD && (
            ...
            >
              ...
              <div className="flex gap-4 pointer-events-auto hidden lg:flex">
                <button
                  onClick={startAITour}
                  className="glass-card px-6 py-3 rounded-full flex items-center gap-3 hover:bg-white/10 transition-all border-white/10 group bg-purple-600/20"
                >
                  <Activity className="w-5 h-5 text-purple-400 animate-pulse" />
                  <span className="text-sm font-bold uppercase tracking-widest">AI Tour Guide</span>
                </button>
                <button
                  onClick={simulateRouteDetection}
                  className="glass-card px-6 py-3 rounded-full flex items-center gap-3 hover:bg-white/10 transition-all border-white/10 group bg-red-600/20"
                >
                  <Zap className="w-5 h-5 text-red-400 animate-pulse" />
                  <span className="text-sm font-bold uppercase tracking-widest">Detect Route</span>
                </button>
                <button
                  onClick={startDemo}
                  className="glass-card px-6 py-3 rounded-full flex items-center gap-3 hover:bg-white/10 transition-all border-white/10 group bg-blue-600/20"
                >
                  <Zap className="w-5 h-5 text-yellow-400 animate-pulse" />
                  <span className="text-sm font-bold uppercase tracking-widest">Judge Demo</span>
                </button>
                <button
                  onClick={() => setView(view === "globe" ? "stadium" : "globe")}
                  className="glass-card px-6 py-3 rounded-full flex items-center gap-3 hover:bg-white/10 transition-all border-white/10 group"
                >
                  {view === "globe" ? <MapIcon className="w-5 h-5 text-blue-400" /> : <Globe className="w-5 h-5 text-blue-400" />}
        ...
        <AnimatePresence>
          {showHUD && (
            <motion.aside
              ...
              className="absolute left-6 top-1/2 -translate-y-1/2 z-50 space-y-4"
            >
              {[
